...
> [!NOTE]
>
> 本仓库基于 [celaraze/cat](https://github.com/celaraze/cat) 的 `old` 分支继续维护，保留原项目的 GPL-3.0 开源协议、原作者来源和对应源码。
...
> [!NOTE]
>
> 最好的反馈方式是在本代码仓库中提交 [Issues](https://github.com/AilonHuang/cat/issues) ，我们在空余时间检查并解决。
...
请通过 [GitHub Security Advisories](https://github.com/AilonHuang/cat/security/advisories/new) 私下提交安全问题，或联系本仓库维护者。请勿在 Issues 中及其它公开社区提交与安全相关的问题以免被恶意利用。
